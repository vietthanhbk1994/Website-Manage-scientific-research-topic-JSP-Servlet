...
<body>
	...
	<%
		...
		int stt=0;
	%>
	<a href="<%=request.getContextPath()%>/admin/setting?load=them" title="" class="themthongbao">Thêm cấp đề tài</a>
	<form action="<%=request.getContextPath()%>/admin/setting" method="get">
